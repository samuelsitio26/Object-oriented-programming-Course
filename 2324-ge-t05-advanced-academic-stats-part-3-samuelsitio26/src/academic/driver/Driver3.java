...
//                 // semester);
//                 // enrollments.add(enrollment);
//                 // memambah kondisi jika ada grade
...
//                 String year = inputArray[3];
//                 String semester = inputArray[4];
//                 String newGrade = inputArray[5]; // New grade for remedial
            
//                 // Find the corresponding enrollment
//                 for (Enrollment e : enrollments) {
//                     if (e.getCode().equals(courseCode) && e.getNim().equals(studentCode)
//                             && e.getTahun().equals(year) && e.getEven().equals(semester)) {
//                         // Record the previous grade
//                         String previousGrade = e.getEven2();
//                         e.setPreviousGrade(previousGrade);
